    ...
    if len(text)>7:
        ...
        if len(argument) == 3:
            ...
            try:
                ...
                return
        temp_msg = await message.reply("Bentar Sayang...")
        try:
            messages = await get_messages(client, ids)
        except:
            await message.reply_text("Ada Kesalahan Dikit..!")
            return
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("😊 Kreator", callback_data = "about"),
...
async def not_joined(client: Client, message: Message):
    text = "<b>Kamu harus subs channel/grup untuk menggunakan perintah ini\n\nSilahkan Join Channel</b>"
